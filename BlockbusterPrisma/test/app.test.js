...
const FavouriteController = require("../controllers/FavoritesController")
...
beforeEach(async()=>{
  ...
  await prisma.favoriteFilms.deleteMany({})
})
...
describe.only('POST /favourite/:code', () => {
...
describe("GET /movies", () => {
  ...
  it("Should return movies", (done) => {
    request(app)
      ...
      .expect(200)
      .then((response) => {
        assert.isNotEmpty(response._body.data);
        assert.isArray(response._body.data);
